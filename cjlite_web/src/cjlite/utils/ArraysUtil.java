...
public class ArraysUtil {
	...
	/**
	 * Finds the first occurrence of given value in <code>float</code> array from specified given position.
	 */
	...
	/**
	 * Finds the first occurrence of given value in <code>double</code> array from specified given position.
	 */
	...
	public static Object[][] to2DimArray(List<?> list) {
		if (list == null) {
			return new Object[0][0];
		}

		Object[][] arrayss = new Object[list.size()][1];

		for (int i = 0; i < list.size(); i++) {
			arrayss[i] = new Object[] { list.get(i) };
		}
