...
/**
 * A <code>ParamPart</code> is an upload part which represents a normal <code>INPUT</code> (for example a non
 * <code>TYPE="file"</code>) form parameter.
 * 
...
public class ParamPart extends Part {
	...
	/**
	 * Returns the value of the parameter as an array of bytes or a zero length array if the user entered no value for
	 * this parameter.
	 * 
	...
	/**
	 * Returns the value of the parameter in as a string (using the parser-specified encoding to convert from bytes) or
	 * the empty string if the user entered no value for this parameter.
	 * 
	...
	/**
	 * Returns the value of the parameter in the supplied encoding or empty string if the user entered no value for this
	 * parameter.
	 * 
	 * @return value of parameter as a string.
	 */
