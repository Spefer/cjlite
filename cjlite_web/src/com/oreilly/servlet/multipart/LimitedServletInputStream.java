...
/**
 * A <code>LimitedServletInputStream</code> wraps another <code>ServletInputStream</code> in order to keep track of how
 * many bytes have been read and detect when the Content-Length limit has been reached. This is necessary since some
 * servlet containers are slow to notice the end of stream and cause the client code to hang if it tries to read past
 * it.
 * 
 * @author Jason Hunter
