...
/**
 * A request wrapper to support MultipartFilter. The filter capability requires Servlet API 2.3.
 * <p>
 ...
 * @version 1.1, 2002/11/15, added getOriginalFileName() to match MultipartRequest
